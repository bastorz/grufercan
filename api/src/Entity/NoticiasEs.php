...
use App\Repository\NoticiasEsRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=NoticiasEsRepository::class)
 */
class NoticiasEs
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Noticias::class, inversedBy="noticiasEs")
     */
    private $id_noticia;
