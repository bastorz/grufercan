      ...
      <div className="flex flex-wrap items-center justify-center gap-[1px]">
        {providerLogos.map((provider, i) => (
          <a
            ...
            key={i}
          >
            <div className="flex items-center justify-center w-32 h-32 border md:w-64 md:h-64 outline outline-1 outline-gray-200">
              <img src={provider.logo} alt="" className="p-5 md:p-10" />
            </div>
          </a>
        ))}
      </div>
